            ...
            if (null !== t) {
                if (a++, 1 === t.nodeType) {
                    if (t.hasAttributes()) {
                        ...
                        let i = 0;
                        for (let t = 0; t < s; t++) d(e[t].name, "$lit$") && i++;
                        for (; i-- > 0;) {
                            const e = c[h],
                                s = u.exec(e)[2],
                                i = s.toLowerCase() + "$lit$",
                    ...
                    if (e.indexOf(r) >= 0) {
                        ...
                        for (let e = 0; e < o; e++) {
                            ...
                            if ("" === o) s = p();
                                ...
                                const t = u.exec(o);
                                null !== t && d(t[2], "$lit$") && (o = o.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]), s = document.createTextNode(o)
                            }
                        ...
                        "" === n[o] ? (i.insertBefore(p(), t), s.push(t)) : t.data = n[o], h += o
                    }
                    ...
                    if (t.data === r) {
                        ...
                        null !== t.previousSibling && a !== o || (a++, e.insertBefore(p(), t)), o = a, this.parts.push({
                            type: "node",
                            index: a
                        }), null === t.nextSibling ? t.data = "" : (s.push(t), a--), h++
                    } else {
                        let e = -1;
...
function A(t) {
    ...
    return s = e.keyString.get(i), void 0 === s && (s = new h(t, t.getTemplateElement()), e.keyString.set(i, s)), e.stringsArray.set(t.strings, s), s
}
const k = new Map,
    V = new WeakMap;
/**
...
function U(t, e) {
    const {
        ...
        parts: i
    } = t, n = document.createTreeWalker(s, 133, null, !1);
    let o = M(i),
        r = i[o],
        a = -1,
        l = 0;
    ...
    for (; n.nextNode();) {
        ...
        for (t.previousSibling === d && (d = null), e.has(t) && (h.push(t), null === d && (d = t)), null !== d && l++; void 0 !== r && r.index === a;) r.index = null !== d ? -1 : r.index - l, o = M(i, o), r = i[o]
    }
...
const j = t => e => {
        ...
        if (n = i.keyString.get(o), void 0 === n) {
            ...
            $ && window.ShadyCSS.prepareTemplateDom(s, t), n = new h(e, s), i.keyString.set(o, n)
        }
...
var et = function(t, e, s, i) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, e, s, i);
        ...
        for (var a = t.length - 1; a >= 0; a--)(n = t[a]) && (r = (o < 3 ? n(r) : o > 3 ? n(e, s, r) : n(e, s)) || r);
...
et([G({
    ...
    type: String
})], st.prototype, "storageUsed", void 0), st = et([(it = "pwa-update", t => "function" == typeof t ? ((t, e) => (window.customElements.define(t, e), e))(it, t) : ((t, e) => {
    const {
        kind: s,
        elements: i
    } = e;
